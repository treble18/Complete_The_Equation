...
class LevelMediumActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        startMedium.setOnClickListener {
            if(isRunning == false) {
    ...
    private fun startTimer(time_in_seconds: Long) {
        countdown_timer = object : CountDownTimer(time_in_seconds, 1000) {
            override fun onFinish() {
                ...
                num1Medium.visibility = View.INVISIBLE
                num1_2Medium.visibility = View.INVISIBLE
                num2Medium.visibility = View.INVISIBLE
                num3Medium.visibility = View.INVISIBLE
                num3_2Medium.visibility = View.INVISIBLE
                num3_3Medium.visibility = View.INVISIBLE
                operatorMedium.visibility = View.INVISIBLE

                zeroMedium.setClickable(false)
                oneMedium.setClickable(false)
                twoMedium.setClickable(false)
                threeMedium.setClickable(false)
                fourMedium.setClickable(false)
                fiveMedium.setClickable(false)
                sixMedium.setClickable(false)
                sevenMedium.setClickable(false)
                eightMedium.setClickable(false)
                nineMedium.setClickable(false)
                addMedium.setClickable(false)
                subtractMedium.setClickable(false)
                multiplyMedium.setClickable(false)
                divideMedium.setClickable(false)
            }
        ...
        if(isRunning) {
            ...
            submit.setOnClickListener {
                when (blankArea) {
                    ...
                    4 -> {
                        if (llnum3Medium.getChildAt(1) != null && llnum3_2Medium.getChildAt(1) != null && llnum3_3Medium.getChildAt(
                                1
                            ) != null
                        ) {
